...
mongoose
  ...
  .catch((err) => {
    ...
    console.error(
      "Ensure MongoDB is running locally or set MONGO_URL in a .env file to a valid URI."
    );
    // Still start the app so frontend/dashboard can load static routes if needed
    app.listen(PORT, () => {
